...
from xlsx import Workbook # pip install py-xlsx or pip install git+https://github.com/pkenjora/py-xlsx
...
def excel_to_rows(excel_file, sheet=None):
  ...
  for excel_sheet in excel_book:
    if sheet is None or sheet == excel_sheet.name:
      yield excel_sheet.name, [[cell.value or cell.formula for cell in cells] for row_number, cells in excel_sheet.rowsIter()]
